...
Shader "EVE/ScreenSpaceCloudShadow" {
	...
	SubShader{
		...
		Pass {
			...
			#pragma multi_compile_local SCATTERER_OCEAN_OFF SCATTERER_OCEAN_ON
			#pragma multi_compile_local VOLUMETRIC_CLOUD_SHADOW_OFF VOLUMETRIC_CLOUD_SHADOW_ON

			//#define VOLUMETRIC_CLOUD_SHADOW_OFF

			#define CLOUD_SHADOW_CASTER_OFF
			#define NOISE_MIPS_ON
			// these are unreadable but I wrote them out to reduce shader permutations
			#pragma multi_compile_local NOISE_OFF NOISE_UNTILING_ON_CURL_NOISE_OFF_FLOWMAP_OFF_SINGLE_NOISE_SCALE_OFF NOISE_UNTILING_ON_CURL_NOISE_OFF_FLOWMAP_OFF_SINGLE_NOISE_SCALE_ON NOISE_UNTILING_ON_CURL_NOISE_OFF_FLOWMAP_ON_SINGLE_NOISE_SCALE_OFF NOISE_UNTILING_ON_CURL_NOISE_OFF_FLOWMAP_ON_SINGLE_NOISE_SCALE_ON NOISE_UNTILING_ON_CURL_NOISE_ON_FLOWMAP_OFF_SINGLE_NOISE_SCALE_OFF NOISE_UNTILING_ON_CURL_NOISE_ON_FLOWMAP_OFF_SINGLE_NOISE_SCALE_ON NOISE_UNTILING_ON_CURL_NOISE_ON_FLOWMAP_ON_SINGLE_NOISE_SCALE_OFF NOISE_UNTILING_ON_CURL_NOISE_ON_FLOWMAP_ON_SINGLE_NOISE_SCALE_ON NOISE_UNTILING_OFF_CURL_NOISE_OFF_FLOWMAP_OFF_SINGLE_NOISE_SCALE_OFF NOISE_UNTILING_OFF_CURL_NOISE_OFF_FLOWMAP_OFF_SINGLE_NOISE_SCALE_ON NOISE_UNTILING_OFF_CURL_NOISE_OFF_FLOWMAP_ON_SINGLE_NOISE_SCALE_OFF NOISE_UNTILING_OFF_CURL_NOISE_OFF_FLOWMAP_ON_SINGLE_NOISE_SCALE_ON NOISE_UNTILING_OFF_CURL_NOISE_ON_FLOWMAP_OFF_SINGLE_NOISE_SCALE_OFF NOISE_UNTILING_OFF_CURL_NOISE_ON_FLOWMAP_OFF_SINGLE_NOISE_SCALE_ON NOISE_UNTILING_OFF_CURL_NOISE_ON_FLOWMAP_ON_SINGLE_NOISE_SCALE_OFF NOISE_UNTILING_OFF_CURL_NOISE_ON_FLOWMAP_ON_SINGLE_NOISE_SCALE_ON
