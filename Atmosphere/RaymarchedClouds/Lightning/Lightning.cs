...
namespace Atmosphere
{
    ...
    {
        // More than this and it tanks the performance because of the lights, especially using Parallax and rain/splashes.
        // This hardcoded limit of 4 is also in the clouds shader
        ...
        static Vector4[] activeLightningShaderUnstableMasks = new Vector4[maxConcurrent];
        ...
        public static void SetUpscalingShaderParams(Material mat)
        {
            if (currentCount > 0)
            {
                mat.SetInt(ShaderProperties.lightningCount_PROPERTY, currentCount);
                mat.SetVectorArray(ShaderProperties.lightningUnstableMasksArray_PROPERTY, activeLightningShaderUnstableMasks);
            }
            else
            {
                mat.SetInt(ShaderProperties.lightningCount_PROPERTY, 0);
